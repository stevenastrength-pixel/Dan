    ...
    <div className="flex-1 flex flex-col items-center justify-center bg-slate-950 gap-6 px-8 text-center">
      ...
      <div>
        ...
        <p className="text-sm text-slate-500 max-w-md">
          Live initiative tracker, HP board, spell slots, conditions — everything
          you need to run a session at the table.
        </p>
        <p className="text-xs text-amber-400 mt-4 font-medium">Coming in Phase B</p>
      </div>
